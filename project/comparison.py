...
h = 0.6774
H0 = 100*h
pars.set_cosmology(H0=H0, ombh2=om_b*h**2)  # , omch2=0, mnu=0.06, omk=0, tau=0.06)
...
plt.plot(ls[199:], unlensedCL[199:, 0], color='r', label=r'CAMB, unlensed')  # for $\Lambda$CDM, unlensed')
plt.plot(Ls[199:], Cls[199:], label='PLANCK 2018')
plt.plot(Ls[199:], C_l(Ls, h=h)[199:]*1000, label='CMBslow', color='orange')
plt.xlabel(r'$\ell$')
plt.ylabel(r'$C_\ell$')
plt.grid()
plt.legend()
plt.savefig(fr"C:\Users\Felix\Desktop\cmbslow\figures\comparison om_b={om_b}.png", transparent=True)
plt.show()
